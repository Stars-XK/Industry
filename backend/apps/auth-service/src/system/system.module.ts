...
@Module({
  ...
  controllers: [UserController, RoleController, DeptController, MenuController, DictController, AuditLogController, ConfigController, BackupController, WizardController],
