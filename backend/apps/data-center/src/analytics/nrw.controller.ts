...
export class NrwController {
  ...
  async getNrwList(@Query('month') month: string) {
    ...
    return [
      { zone_id: 101, zone_name: '丰泽东海科技园区', report_month: month || '2026-03', supply: 125000, sale: 105000, loss_rate: 16.0 },
      { zone_id: 102, zone_name: '鲤城洛江开发区', report_month: month || '2026-03', supply: 85000, sale: 75000, loss_rate: 11.7 },
      { zone_id: 103, zone_name: '泉港西湖新片区', report_month: month || '2026-03', supply: 42000, sale: 36000, loss_rate: 14.2 }
    ];
  }
