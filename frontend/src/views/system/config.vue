    ...
    <div class="settings-layout">
      ...
      <el-form :model="formData" label-width="150px" class="config-form">
        <el-tabs v-model="activeTab" class="config-tabs" type="border-card">
          <el-tab-pane label="基础信息配置" name="basic">
            <el-row :gutter="20">
              <el-col :span="12">
          ...
          <el-tab-pane label="GIS 地图引擎配置" name="map">
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="地图来源" prop="sys.map.source">
                  <el-select v-model="formData['sys.map.source']" placeholder="选择地图底层" style="width: 100%;">
                    <el-option label="高德地图 (Amap)" value="amap" />
                    <el-option label="百度地图 (Baidu)" value="baidu" />
                    <el-option label="天地图 (Tianditu)" value="tianditu" />
          ...
          <el-tab-pane label="系统主题与视觉配置" name="theme">
            <el-row :gutter="20">
              <el-col :span="12">
          ...
          <el-tab-pane label="通知通道配置" name="notification">
            <el-row :gutter="20">
              <el-col :span="12">
