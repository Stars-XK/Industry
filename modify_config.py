...
path = '/workspace/frontend/src/views/system/config.vue'
with open(path, 'r', encoding='utf-8') as f:
    content = f.read()

# Make it look like a macOS settings panel
new_style = """
<style scoped>
.config-container {
  padding: 0;
...
# Add missing icons
content = content.replace("import { Setting, Check } from '@element-plus/icons-vue';", "import { Setting, Check, Brush, Location, Message } from '@element-plus/icons-vue';")

with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated config.vue")
